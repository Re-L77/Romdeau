...
export const colonias: Colonia[] = [
  { id: 1, nombre: 'Crédito Constructor', codigo_postal: '03940', municipio_id: 1 },
  { id: 2, nombre: 'San Pedro de los Pinos', codigo_postal: '03800', municipio_id: 1 },
...
export const categorias: Categoria[] = [
  { id: 'cat-001', nombre: 'Equipos de Cómputo', tipo_rastreo: TipoRastreo.MOVIL, vida_util_anios: 5, porcentaje_depreciacion: 20 },
  { id: 'cat-002', nombre: 'Mobiliario de Oficina', tipo_rastreo: TipoRastreo.FIJO, vida_util_anios: 10, porcentaje_depreciacion: 10 },
  { id: 'cat-003', nombre: 'Vehículos', tipo_rastreo: TipoRastreo.MOVIL, vida_util_anios: 8, porcentaje_depreciacion: 12.5 },
  { id: 'cat-004', nombre: 'Servidores y Equipos de Red', tipo_rastreo: TipoRastreo.FIJO, vida_util_anios: 5, porcentaje_depreciacion: 20 },
  { id: 'cat-005', nombre: 'Equipos de Audio/Video', tipo_rastreo: TipoRastreo.MOVIL, vida_util_anios: 7, porcentaje_depreciacion: 14.29 },
  { id: 'cat-006', nombre: 'Herramientas y Maquinaria', tipo_rastreo: TipoRastreo.FIJO, vida_util_anios: 15, porcentaje_depreciacion: 6.67 },
];
...
export const proveedores: Proveedor[] = [
  ...
  },
  {
    ...
    direccion_fiscal: 'Blvd. Manuel Ávila Camacho 36, Lomas de Chapultepec, CDMX',
...
export const activos: Activo[] = [
  {
    ...
    foto_principal_url: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca4',
...
export const datosFinancieros: DatosFinancieros[] = [
  {
    ...
    costo_adquisicion: 3499.00,
    valor_libro_actual: 2799.20,
  ...
  },
  {
    ...
    costo_adquisicion: 1850.00,
    valor_libro_actual: 1665.00,
  ...
  },
  {
    ...
    costo_adquisicion: 8900.00,
    valor_libro_actual: 5340.00,
  ...
  },
  {
    activo_id: 'act-005',
    proveedor_id: 'prov-001',
    costo_adquisicion: 1299.00,
    valor_libro_actual: 1039.20,
...
export const logsAuditoria: LogAuditoria[] = [
  {
    ...
    comentarios: 'Activo verificado en perfectas condiciones, ubicación correcta.',
  },
  {
    id: 'log-002',
    activo_id: 'act-002',
  ...
  },
  {
    ...
    coordenadas_gps: { latitude: 19.3690, longitude: -99.1702 },
    estado_reportado_id: EstadoAuditoria.BUENO,
...
export const logsDepreciacion: LogDepreciacion[] = [
  {
    ...
    valor_anterior: 3499.00,
    monto_depreciado: 699.80,
    valor_nuevo: 2799.20,
  ...
  },
  {
    ...
    valor_anterior: 12500.00,
    monto_depreciado: 2500.00,
    valor_nuevo: 10000.00,
    metodo_usado: 'LINEA_RECTA',
  },
];
...
export const alertasSistema: AlertaSistema[] = [
  {
    id: 'alert-001',
    activo_id: 'act-005',
    tipo_alerta: TipoAlerta.VENCIMIENTO_GARANTIA,
    mensaje: 'La garantía del iPad Pro 12.9" vence en 30 días',
    fecha_disparo: '2024-12-20',
    leida: false,
    usuario_destino_id: 'usr-002',
    created_at: '2024-12-20T08:00:00Z',
  },
  {
    id: 'alert-002',
    activo_id: 'act-004',
    tipo_alerta: TipoAlerta.MANTENIMIENTO_PREVENTIVO,
    mensaje: 'Switch Cisco requiere mantenimiento preventivo programado',
    fecha_disparo: '2026-02-25',
    leida: false,
    usuario_destino_id: 'usr-001',
    created_at: '2026-02-25T09:00:00Z',
  },
  {
    id: 'alert-003',
    activo_id: 'act-006',
    tipo_alerta: TipoAlerta.DEPRECIACION_CERO,
    mensaje: 'Silla ergonómica ha alcanzado depreciación completa',
    fecha_disparo: '2026-01-15',
    leida: true,
    usuario_destino_id: 'usr-004',
...
export const bajasActivos: BajaActivo[] = [
  {
    ...
    monto_recuperado: 150.00,
    documento_respaldo_url: 'https://docs.romdeau.com/bajas/2026/act-006-baja.pdf',
...
export function getDiasHastaVencimientoGarantia(activoId: string): number | null {
